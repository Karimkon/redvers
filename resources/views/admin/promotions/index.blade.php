                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('admin.promotions.edit', $promo) }}" class="btn btn-outline-warning">
                                            <i class="bi bi-pencil-square"></i>
                                        </a>
                                        <form method="POST" action="{{ route('admin.promotions.destroy', $promo) }}" onsubmit="return confirm('Delete this promotion?')" class="d-inline">
                                            @csrf @method('DELETE')
