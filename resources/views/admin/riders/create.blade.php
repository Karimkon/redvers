...
@section('title', 'Redvers Riders Registration')
                ...
                <form method="POST" action="{{ route('admin.riders.store') }}" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="nin_number" value="{{ old('nin_number') }}" class="form-control">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="file" name="id_front" accept="image/*" class="form-control" onchange="previewImage(event, 'idFrontPreview')">
                            <img id="idFrontPreview" src="#" alt="Preview" class="mt-2 img-thumbnail" style="max-height: 120px; display: none;">
                        </div>

                        <div class="col-md-6">
                            <label class="form-label">National ID Back</label>
                            <input type="file" name="id_back" accept="image/*" class="form-control" onchange="previewImage(event, 'idBackPreview')">
                            <img id="idBackPreview" src="#" alt="Preview" class="mt-2 img-thumbnail" style="max-height: 120px; display: none;">
                        </div>
